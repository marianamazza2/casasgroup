...
function SegurosPage() {
  return (
    <main className="servicio-page">
      ...
      <PorQueNosotros />
      <CtaBanner />
      <ServiceFooter currentId="seguros" />
    </main>
  )
}
...
// cobertura. La sección entera entra con una aparición suave al hacer scroll.
    ...
    <section className="seguros-porque">
      ...
      <div className="seguros-porque-content">
        <div className="section-heading">
          ...
          <h2>Gestiona tus seguros con quien conoce tu vivienda</h2>
        </div>
  ...
  return (
    <section ref={ref} className={`adm-cta${active ? ' is-active' : ''}`}>
      ...
      <div className="adm-cta-inner">
        <span className="adm-cta-eyebrow">Seguros</span>
        <h2 className="adm-cta-title">¿Quieres proteger tu vivienda?</h2>
